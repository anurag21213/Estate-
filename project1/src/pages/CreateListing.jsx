      ...
      <form className='flex flex-col sm:flex-row gap-4 ' onSubmit={handleSubmit} >
        ...
        <div className='flex flex-col flex-1'>
         ...
         <div className='flex gap-4'>
           ...
           <button className='bg-slate-900 text-white uppercase p-3 rounded-lg hover:opacity-95 disabled:opacity-80 my-3' disabled={loading||uploading}>{loading?'Creating...':'Create Listing'}</button>
